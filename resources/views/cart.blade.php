  ...
  <div class="max-w-5xl mx-auto">
    ...
    <form action="" method="POST" class="space-y-6">
      ...
      <div class="flex items-center gap-4 border-b pb-6">
        ...
        <img src="{{ asset('images/terpal-ayam.png') }}" alt="Gambar Produk" class="w-20 h-20 object-cover rounded-md">
        ...
        <div class="text-right">
          ...
          <form method="POST" action="{{ route('keranjang.delete', $item->id) }}">
            @csrf
            <button type="submit" class="text-red-500 text-xs mt-2 hover:underline">Hapus</button>
          </form>
        </div>
      </div>
      @endforeach
      ...
      <div class="flex justify-end mt-8">
        <a href="{{ route('checkout') }}" class="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-6 rounded-md">
          Lanjut Bayar
        </a>
      </div>
    </form>
