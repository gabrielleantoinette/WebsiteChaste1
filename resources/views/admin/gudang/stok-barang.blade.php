...
<div class="py-4 sm:py-5 lg:py-6">
    ...
    <div class="relative overflow-hidden bg-gradient-to-r from-teal-500 to-teal-600 rounded-xl mb-4 sm:mb-6 lg:mb-8">
        ...
        <div class="relative px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-1 sm:mb-2">📦 Stok Barang Gudang</h1>
                    <p class="text-sm sm:text-base text-teal-100">Ringkasan stok produk, bahan baku, dan custom materials</p>
                </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-5 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
        <div class="bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="p-2 sm:p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                         stroke-width="2" stroke="currentColor" class="w-5 h-5 sm:w-6 sm:h-6 text-blue-600 dark:text-blue-400">
            ...
            <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Total Produk</p>
            <p class="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-600 dark:text-blue-400 truncate">{{ $products->count() }}</p>
        </div>
        <div class="bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="p-2 sm:p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                         stroke-width="2" stroke="currentColor" class="w-5 h-5 sm:w-6 sm:h-6 text-purple-600 dark:text-purple-400">
            ...
            <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Total Custom Material</p>
            <p class="text-xl sm:text-2xl lg:text-3xl font-bold text-purple-600 dark:text-purple-400 truncate">{{ $customMaterials->count() }}</p>
        </div>
        <div class="bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="p-2 sm:p-3 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                         stroke-width="2" stroke="currentColor" class="w-5 h-5 sm:w-6 sm:h-6 text-orange-600 dark:text-orange-400">
            ...
            <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Total Bahan Baku</p>
            <p class="text-xl sm:text-2xl lg:text-3xl font-bold text-orange-600 dark:text-orange-400 truncate">{{ $rawMaterials->count() }}</p>
        </div>
        <div class="bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="p-2 sm:p-3 bg-green-100 dark:bg-green-900/30 rounded-lg flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                         stroke-width="2" stroke="currentColor" class="w-5 h-5 sm:w-6 sm:h-6 text-green-600 dark:text-green-400">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
                    </svg>
                </div>
            </div>
            <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Total Stok Tersedia</p>
            <p class="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold text-green-600 dark:text-green-400 truncate">
        ...
        <div class="bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="p-2 sm:p-3 bg-red-100 dark:bg-red-900/30 rounded-lg flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                         stroke-width="2" stroke="currentColor" class="w-5 h-5 sm:w-6 sm:h-6 text-red-600 dark:text-red-400">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                    </svg>
                </div>
            </div>
            <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Stok Rendah (≤10)</p>
            <p class="text-xl sm:text-2xl lg:text-3xl font-bold text-red-600 dark:text-red-400 truncate">
    ...
    <div class="bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg mb-4 sm:mb-6 lg:mb-8">
        <h2 class="text-base sm:text-xl font-semibold text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">Produk Regular</h2>
        {{-- Desktop Table View --}}
                ...
                <div class="p-4 hover:bg-teal-50 dark:hover:bg-[#003333] transition">
                    <div class="flex justify-between items-start mb-3">
                        <div class="flex-1 min-w-0">
                            ...
                            <span class="inline-block mt-1 px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded text-xs">
                                {{ $product->category->name ?? 'Tanpa Kategori' }}
                            </span>
                        </div>
                        <span class="inline-block px-2 sm:px-3 py-1 rounded-full text-xs font-semibold ml-2 flex-shrink-0
                            @if($product->variants->sum('stock') <= 10) bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400
                            @elseif($product->variants->sum('stock') <= 50) bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400
                            @else bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400
                            @endif">
                            @if($product->variants->sum('stock') <= 10) Stok Rendah
                            @elseif($product->variants->sum('stock') <= 50) Stok Menengah
                            @else Stok Aman
                            @endif
                        </span>
                    </div>
                    <div class="mb-3">
                        <p class="text-xs text-gray-600 dark:text-gray-400 mb-2">Total Stok:</p>
                        <p class="text-lg font-bold {{ $product->variants->sum('stock') <= 10 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                            {{ number_format($product->variants->sum('stock'), 0, ',', '.') }}
                        </p>
                    </div>
                    <div class="mb-3">
                        <p class="text-xs text-gray-600 dark:text-gray-400 mb-2">Detail Stok per Warna:</p>
                        <div class="space-y-1">
                            @forelse ($product->variants as $variant)
                                <div class="flex justify-between items-center text-xs bg-gray-50 dark:bg-[#2c2c2c] p-2 rounded">
                                    <span class="font-medium text-gray-700 dark:text-gray-300">{{ $variant->color }}</span>
                                    <span class="px-2 py-1 rounded text-xs font-semibold {{ $variant->stock <= 10 ? 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400' : 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' }}">
                                        {{ $variant->stock }}
                                    </span>
            ...
            @empty
                <div class="p-4 text-center text-gray-500 dark:text-gray-400">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-base font-medium">Tidak ada produk regular</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Produk akan muncul di sini setelah ditambahkan</p>
                    </div>
                </div>
            @endforelse
        </div>
    ...
    {{-- Bahan Baku --}}
    <div class="bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg mb-4 sm:mb-6 lg:mb-8">
        <h2 class="text-base sm:text-xl font-semibold text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">Bahan Baku</h2>
        {{-- Desktop Table View --}}
        <div class="hidden lg:block overflow-x-auto">
            <table class="min-w-full table-auto data-table text-sm border border-gray-200 dark:border-gray-700">
                <thead class="bg-gray-100 dark:bg-[#004d4d] text-gray-700 dark:text-[#ccf2f2]">
        ...
        <div class="lg:hidden divide-y divide-gray-200 dark:divide-gray-700">
            @forelse ($rawMaterials as $material)
                <div class="p-4 hover:bg-orange-50 dark:hover:bg-[#332700] transition">
                    <div class="flex justify-between items-start mb-3">
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-200 truncate">{{ $material->name }}</p>
                            <span class="inline-block mt-1 px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded text-xs">
                                {{ $material->unit ?? '-' }}
                            </span>
                        </div>
                        <span class="inline-block px-2 sm:px-3 py-1 rounded-full text-xs font-semibold ml-2 flex-shrink-0
                            @if($material->stock <= 10) bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400
                            @elseif($material->stock <= 50) bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400
                            @else bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400
                            @endif">
                            @if($material->stock <= 10) Stok Rendah
                            @elseif($material->stock <= 50) Stok Menengah
                            @else Stok Aman
                            @endif
                        </span>
                    </div>
                    <div>
                        <p class="text-xs text-gray-600 dark:text-gray-400 mb-1">Stok (m²):</p>
                        <p class="text-lg font-bold {{ $material->stock <= 10 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                            {{ number_format($material->stock, 2, ',', '.') }}
                        </p>
                    </div>
                </div>
            @empty
                <div class="p-4 text-center text-gray-500 dark:text-gray-400">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-base font-medium">Tidak ada bahan baku</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Bahan baku akan muncul di sini setelah ditambahkan</p>
                    </div>
                </div>
            @endforelse
        </div>
    ...
    <div class="bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg">
        <h2 class="text-base sm:text-xl font-semibold text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">Custom Materials</h2>
        {{-- Desktop Table View --}}
        <div class="hidden lg:block overflow-x-auto">
            <table class="min-w-full table-auto data-table text-sm border border-gray-200 dark:border-gray-700">
                <thead class="bg-gray-100 dark:bg-[#004d4d] text-gray-700 dark:text-[#ccf2f2]">
        ...
        <div class="lg:hidden divide-y divide-gray-200 dark:divide-gray-700">
            @forelse ($customMaterials as $material)
                <div class="p-4 hover:bg-purple-50 dark:hover:bg-[#2d0033] transition">
                    <div class="flex justify-between items-start mb-3">
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-200 truncate">{{ $material->name }}</p>
                        </div>
                        <span class="inline-block px-2 sm:px-3 py-1 rounded-full text-xs font-semibold ml-2 flex-shrink-0
                            @if($material->variants->sum('stock') <= 10) bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400
                            @elseif($material->variants->sum('stock') <= 50) bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400
                            @else bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400
                            @endif">
                            @if($material->variants->sum('stock') <= 10) Stok Rendah
                            @elseif($material->variants->sum('stock') <= 50) Stok Menengah
                            @else Stok Aman
                            @endif
                        </span>
                    </div>
                    <div class="mb-3">
                        <p class="text-xs text-gray-600 dark:text-gray-400 mb-2">Total Stok:</p>
                        <p class="text-lg font-bold {{ $material->variants->sum('stock') <= 10 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                            {{ number_format($material->variants->sum('stock'), 0, ',', '.') }}
                        </p>
                    </div>
                    <div class="mb-3">
            ...
            @empty
                <div class="p-4 text-center text-gray-500 dark:text-gray-400">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-base font-medium">Tidak ada custom materials</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Custom materials akan muncul di sini setelah ditambahkan</p>
                    </div>
                </div>
            @endforelse
        </div>
