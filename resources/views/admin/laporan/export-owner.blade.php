...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <form method="GET" action="{{ route('owner.laporan.download') }}" class="space-y-3">
                <div>
                    ...
                    <p id="transaksi-desc" class="text-xs text-gray-500 mt-1">{{ $reportRangeOptions[0]['description'] }}</p>
                </div>
                <div id="transaksi-date" class="hidden">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center gap-3 mb-4">
                ...
                <h3 class="text-lg font-semibold text-gray-800">Laporan Payment Gateway</h3>
            </div>
            <form method="GET" action="{{ route('owner.laporan.payment-gateway') }}" class="space-y-3">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Rentang Waktu</label>
                    ...
                    <p id="payment-desc" class="text-xs text-gray-500 mt-1">{{ $reportRangeOptions[0]['description'] }}</p>
                </div>
                <div id="payment-date" class="hidden">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Tanggal</label>
                    <input type="date" name="date" disabled
                           value="{{ request('date', now()->toDateString()) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                </div>
                <div id="payment-month" class="hidden">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Bulan</label>
                    <input type="month" name="month" disabled
                           value="{{ request('month', now()->format('Y-m')) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                </div>
                <div id="payment-year" class="hidden">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Tahun</label>
                    <input type="number" name="year" min="2000" max="{{ now()->year }}" disabled
                           value="{{ request('year', now()->year) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center gap-3 mb-4">
                ...
                <h3 class="text-lg font-semibold text-gray-800">Laporan Negosiasi</h3>
            </div>
            <form method="GET" action="{{ route('owner.laporan.negosiasi') }}" class="space-y-3">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Rentang Waktu</label>
                    ...
                    <p id="negosiasi-desc" class="text-xs text-gray-500 mt-1">{{ $reportRangeOptions[0]['description'] }}</p>
                </div>
                <div id="negosiasi-date" class="hidden">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Tanggal</label>
                    <input type="date" name="date" disabled
                           value="{{ request('date', now()->toDateString()) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                </div>
                <div id="negosiasi-month" class="hidden">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Bulan</label>
                    <input type="month" name="month" disabled
                           value="{{ request('month', now()->format('Y-m')) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                </div>
                <div id="negosiasi-year" class="hidden">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Tahun</label>
                    <input type="number" name="year" min="2000" max="{{ now()->year }}" disabled
                           value="{{ request('year', now()->year) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center gap-3 mb-4">
                ...
                <h3 class="text-lg font-semibold text-gray-800">Laporan Driver</h3>
            </div>
            <form method="GET" action="{{ route('owner.laporan.driver') }}" class="space-y-3">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Rentang Waktu</label>
                    ...
                    <p id="driver-desc" class="text-xs text-gray-500 mt-1">{{ $reportRangeOptions[0]['description'] }}</p>
                </div>
                <div id="driver-date" class="hidden">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Tanggal</label>
                    <input type="date" name="date" disabled
                           value="{{ request('date', now()->toDateString()) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                </div>
                <div id="driver-month" class="hidden">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Bulan</label>
                    <input type="month" name="month" disabled
                           value="{{ request('month', now()->format('Y-m')) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                </div>
                <div id="driver-year" class="hidden">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Tahun</label>
                    <input type="number" name="year" min="2000" max="{{ now()->year }}" disabled
                           value="{{ request('year', now()->year) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
