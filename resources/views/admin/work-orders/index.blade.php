...
@section('content')
    ...
    <div class="relative overflow-hidden bg-gradient-to-r from-teal-500 to-teal-600 rounded-xl mb-8">
        ...
        <div class="relative px-8 py-6">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">📋 Surat Perintah Kerja</h1>
                    <p class="text-teal-100">Manajemen surat perintah kerja dan tugas produksi</p>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white dark:bg-[#1e1e1e] rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Total Surat Perintah</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ $workOrders->count() }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-[#1e1e1e] rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Menunggu Pengerjaan</p>
                    <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $workOrders->where('status', 'dibuat')->count() }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-[#1e1e1e] rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Sedang Dikerjakan</p>
                    <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{{ $workOrders->where('status', 'dikerjakan')->count() }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-[#1e1e1e] rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $workOrders->where('status', 'selesai')->count() }}</p>
                </div>
    ...
    <div class="bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-lg">
        <h2 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">Daftar Surat Perintah Kerja</h2>
