...
@section('content')
    <div class="flex justify-between mb-5">
        ...
        <a href="{{ url('/admin/customers/create') }}" class="inline-flex items-center gap-2 px-4 py-2 border border-teal-600 text-teal-600 font-medium rounded-md hover:bg-teal-50 transition shadow-sm">
