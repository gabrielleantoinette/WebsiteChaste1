        ...
        <div class="mb-4 sm:mb-6">
            ...
            @if (!$invoice->gudang)
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                    ...
                    <p class="text-xs sm:text-sm text-yellow-700 mb-2 sm:mb-3">Upload foto bukti kualitas barang sebelum klik "Siapkan Barang".</p>
                    <form action="{{ url('/admin/gudang-transaksi/assign-gudang/' . $invoice->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" id="quality_proof_photo" name="quality_proof_photo" accept="image/*" class="block w-full text-xs sm:text-sm text-gray-500 file:mr-4 file:py-1.5 sm:file:py-2 file:px-3 sm:file:px-4 file:rounded-full file:border-0 file:text-xs sm:file:text-sm file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100" required>
                        ...
                        <div class="mb-3">
                            ...
                            <a href="{{ $imageUrl }}" target="_blank" class="inline-block">
                                <img src="{{ $imageUrl }}" 
                                     ...
                                     class="w-full sm:max-w-xs rounded-lg border hover:opacity-80 transition cursor-pointer"
